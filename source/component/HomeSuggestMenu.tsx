...
return(
    <div className='suggestMenuContainer'>
        <div className='suggestMenu suggestMenu-1'>
            ...
            <Link to='/' className='suggestMenuButton suggestMenuButton-1 material-symbols-rounded'>arrow_forward</Link>
        </div>
        <div className='suggestMenu suggestMenu-2'>
            ...
            <div className='suggestMenuDetail'>ดูรายละเอียด</div>
            <Link to='/' className='suggestMenuButton suggestMenuButton-2 material-symbols-rounded'>arrow_forward</Link>
        </div>
        <div className='suggestMenu suggestMenu-3'>
            ...
            <div className='suggestMenuDetail'>ดูรายละเอียด</div>
            <Link to='/' className='suggestMenuButton suggestMenuButton-3 material-symbols-rounded'>arrow_forward</Link>
        </div>
